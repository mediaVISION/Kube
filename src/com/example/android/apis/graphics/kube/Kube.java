...
/************** 
Copied from KubeOrg.java by Rene
(1) Start of copied block of code
**************/
import com.example.android.apis.graphics.kube.util.SystemUiHider;
...
/************** 
 Modified by Rene
         ...
         The above setContentView(mView) won't do using the generated XML file.
         But fortunately, the generated file uses FrameLaout's which can have child Views.
         So all we have to do is add the glSurfaceView (mView) as a child to the 
         FrameLayout (@+id/bucketFrame) we inserted in KUBE.XML...
...
**************/
		...
		final FrameLayout mBucketFrame = (FrameLayout) findViewById(R.id.bucketFrame);	// Our inserted FrameLayout...
		mBucketFrame.addView(mView);
		
/**************
 Copied from KubeOrg.java by Rene 
 (2) Start of copied block of code
**************/
...
/**************
 Copied from KubeOrg.java by Rene 
 (3) Start of copied block of code
**************/
    @Override
